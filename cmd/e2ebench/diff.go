...
// them against the repo's own tests, and �?because the agent is stochastic �?// retries up to o.attempts times until a run passes, keeping the best result.
...
// repoRelFromModulePath turns "github.com/PeneyLove/ai-novel-matrix-studio/internal/agent/foo.go" into
...
func repoRelFromModulePath(p string) string {
	...
	prefix := "github.com/PeneyLove/ai-novel-matrix-studio/"
