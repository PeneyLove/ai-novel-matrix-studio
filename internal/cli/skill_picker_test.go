...
func makeTestSkills() []skill.Skill {
	return []skill.Skill{
		{Name: "review", Description: "Review code changes for correctness", Scope: skill.ScopeProject, Path: "/fake/proj/.novel-agent/skills/review/SKILL.md", RunAs: skill.RunSubagent, Body: "# Review\n\nReview code."},
		...
		{Name: "test", Description: "Run tests and validate behavior", Scope: skill.ScopeProject, Path: "/fake/proj/.novel-agent/skills/test.md", RunAs: skill.RunInline, Body: "# Test\n\nRun the tests."},
	}
}
...
func TestSkillPickerSourceView(t *testing.T) {
	skills := makeTestSkills()
	roots := []skillRootLine{
		{dir: "/fake/proj/.novel-agent/skills", scope: skill.ScopeProject, status: skill.StatusOK, skills: 2, diagnostic: true},
	...
	if !strings.Contains(out, ".novel-agent") {
...
func TestSkillPickerDiagnostics(t *testing.T) {
	roots := []skillRootLine{
		...
		{dir: "/proj/.novel-agent/skills", scope: skill.ScopeProject, status: skill.StatusOK, skills: 1, diagnostic: true},
...
func TestSkillPickerDetailShowsActionsBeforeBodyPreview(t *testing.T) {
	s := skill.Skill{
		...
		Path:        "/proj/.novel-agent/skills/review/SKILL.md",
...
func TestPathBoundaryMatching(t *testing.T) {
	skills := []skill.Skill{
		{Name: "alpha", Scope: skill.ScopeProject, Path: "/proj/.novel-agent/skills/alpha/SKILL.md"},
		{Name: "beta", Scope: skill.ScopeProject, Path: "/proj/.novel-agent/skills-extra/beta/SKILL.md"},
	}
	lines := []skillRootLine{
		{dir: "/proj/.novel-agent/skills", scope: skill.ScopeProject, status: skill.StatusOK},
		{dir: "/proj/.novel-agent/skills-extra", scope: skill.ScopeProject, status: skill.StatusOK},
	}
...
func TestLegacySkillShowUnchanged(t *testing.T) {
	s := skill.Skill{
		...
		Scope:       skill.ScopeProject,
		Path:        "/fake/proj/.novel-agent/skills/my-skill.md",
		Body:        "# My Skill\n\nSome body text.",
	}
...
func TestLegacySkillPathsUnchanged(t *testing.T) {
	roots := []skill.Root{
		{Dir: "/proj/.novel-agent/skills", Scope: skill.ScopeProject, Priority: 0, Status: skill.StatusOK},
	}
