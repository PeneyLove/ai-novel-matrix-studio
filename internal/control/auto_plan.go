...
// (explain / show / what / why / 解释 / 查一�?�? skip straight to the executor;
...
func isLowRiskQuestion(lower string) bool {
	...
	if strings.HasPrefix(lower, "解释") || strings.HasPrefix(lower, "说明") ||
		strings.HasPrefix(lower, "怎么�?) || strings.HasPrefix(lower, "查一�?) ||
