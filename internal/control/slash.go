...
func themeArgItems(prior []string) []SlashItem {
	...
	items := []SlashItem{
		{Label: "auto", Insert: "auto", Hint: "mode 路 detect system or terminal background"},
		{Label: "light", Insert: "light", Hint: "mode 路 force light shell"},
		{Label: "dark", Insert: "dark", Hint: "mode 路 force dark shell"},
	}
...
func ragArgItems(prior []string) []SlashItem {
	if len(prior) <= 1 {
		return []SlashItem{
			{Label: "init", Insert: "init ", Hint: "set up local ragCore directory", Descend: true},
			{Label: "remote", Insert: "remote ", Hint: "configure remote RAG service", Descend: true},
			{Label: "enable", Insert: "enable", Hint: "enable RAG tool"},
			{Label: "disable", Insert: "disable", Hint: "disable RAG tool"},
			{Label: "topk", Insert: "topk ", Hint: "set retrieval count (1-50)", Descend: true},
			{Label: "config", Insert: "config", Hint: "show raw RAG config"},
		}
	}
	return nil
}
