...
import (
	...
	"github.com/PeneyLove/ai-novel-matrix-studio/internal/billing"
	"github.com/PeneyLove/ai-novel-matrix-studio/internal/checkpoint"
	...
	"github.com/PeneyLove/ai-novel-matrix-studio/internal/nilutil"
...
// headless `novel-agent run` path, where the Sink renders to stdout and the caller
...
// out of project novel-agent.toml while preserving the CLI AddMCPServer semantics.
...
// novel-agent.md by default) — the write side of "#<note>". Returns the file written.
