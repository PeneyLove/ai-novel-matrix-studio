...
func TestTextSinkReproducesInlineOutput(t *testing.T) {
	...
	want := "\x1b[2m  鈻?thinking\x1b[0m\n" + // reasoning header
		"Hello" + // answer delta
		"\n" + // Message close (no renderer)
		"  路 1200 tok 路 in 1000 (900 cached / 100 new) 路 out 200\n" + // usage
		"  -> read_file {\"path\":\"a\"}\n" + // tool dispatch
		// successful read_file result is silent
		"  鈯?bash blocked by permission policy\n" + // blocked result
		"  路 tool output truncated: 5 of 100 bytes elided\n" + // info notice
