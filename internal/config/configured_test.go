...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "novel-agent_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "novel-agent_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "novel-agent_TEST_MISSING"}, false},
