...
// takes precedence), then the novel-agent-owned global credentials file in the user
// config dir (where `novel-agent setup` writes keys, so they resolve from any
