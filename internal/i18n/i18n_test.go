...
// $LC_ALL / $NOVEL_AGENT_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that NOVEL_AGENT_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("NOVEL_AGENT_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("NOVEL_AGENT_LANG=en overriding LANG=zh: got %q, want en", got)
	}
