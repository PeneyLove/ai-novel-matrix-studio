// Package checkpoint is novel-agent's snapshot-based edit safety net. Before a writer
...
import (
	...
	fileenc "github.com/PeneyLove/ai-novel-matrix-studio/internal/fileutil/encoding"
)
